...
// describe is used to group multiple tests (it blocks) under a common label/test suites that describes what is being tested
// So with describe we can put all the tests that belong to this unit (our function)
